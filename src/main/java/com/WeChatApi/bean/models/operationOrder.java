...
public class operationOrder {
	...
	private	String	order_entry_tried_time;
	...
	private	String	order_exit_tried_time;
	...
	private	String	post_entry_time;

	private	String	post_exit_time;
	...
	private	String	order_cancel_arrears_time;
	...
	public String getOrder_entry_tried_time() {
		return order_entry_tried_time;
	}
	public void setOrder_entry_tried_time(String order_entry_tried_time) {
	...
	public String getOrder_exit_tried_time() {
		return order_exit_tried_time;
	}
	public void setOrder_exit_tried_time(String order_exit_tried_time) {
	...
	public String getPost_entry_time() {
		return post_entry_time;
	}
	public void setPost_entry_time(String post_entry_time) {
		this.post_entry_time = post_entry_time;
	}
	public String getPost_exit_time() {
		return post_exit_time;
	}
	public void setPost_exit_time(String post_exit_time) {
	...
	public String getOrder_cancel_arrears_time() {
		return order_cancel_arrears_time;
	}
	public void setOrder_cancel_arrears_time(String order_cancel_arrears_time) {
