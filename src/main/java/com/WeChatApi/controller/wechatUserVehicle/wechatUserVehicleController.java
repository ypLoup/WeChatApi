package com.WeChatApi.controller.wechatUserVehicle;
...
@RequestMapping("/wechatUserVehicle")
@Controller
public class wechatUserVehicleController extends BaseController {
	
	
	@Autowired
	private wechatUserVehicleService userVehicleservice;
	...
	public ModelMap findUserVehicleInfoByConditions(@RequestBody wechatUserVehicleCondition condition) throws JsonProcessingException {
		logger.info("apiName:"+"/wechatUserVehicle/findUserVehicleInfo"+"; param:"+new ObjectMapper().writeValueAsString(condition));
	...
	public ModelMap addUserVehicleInfo(@RequestBody wechatUserVehicle userVehicle) throws JsonProcessingException {
		logger.info("apiName:"+"/wechatUserVehicle/addUserVehicleInfo"+"; param:"+new ObjectMapper().writeValueAsString(userVehicle));
		try {
			if (true) {
	...
	@RequestMapping(value = "/updateWechatUserVehicleInfo", method = RequestMethod.POST)
	@ResponseBody
	public ModelMap updateWechatUserVehicleInfo(@RequestBody wechatUserVehicle userVehicle) throws JsonProcessingException {
		logger.info("apiName:"+"/wechatUserVehicle/updateWechatUserVehicleInfo"+"; param:"+new ObjectMapper().writeValueAsString(userVehicle));
		try {
			if (true) {
	...
	@ResponseBody
	public ModelMap deleteVehicle(@RequestBody wechatUserVehicle userVehicle) {
		try {
